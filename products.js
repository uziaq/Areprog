/* AREPROG - products.js - 15/03/2026 */
...
const AREPROG_PRODUCTS = [
  ...
  },
  {
    ...
    "benefits": [
      ...
      },
      {
        "icon": "⚙️",
        "label": "Sur-mesure",
        "desc": "Cartographie adaptée à vos modifications spécifiques"
      },
      {
        "icon": "🏁",
        "label": "Usage piste possible",
        "desc": "Cartographies spéciales circuit disponibles"
      },
      {
        "icon": "🛡️",
        "label": "Garantie 2 ans",
        "desc": "Sur la prestation cartographie"
      }
    ],
    "features": [
    ...
    "process": [
      {
        "step": "01",
        "title": "Bilan mécanique",
        "desc": "Évaluation complète du véhicule et des modifications existantes."
      },
      {
        "step": "02",
        "title": "Devis sur-mesure",
        "desc": "Proposition de modifications mécaniques et tarif personnalisé."
      },
      {
        "step": "03",
        "title": "Modifications",
        "desc": "Installation des pièces de performance (admission, échappement, etc.)."
      },
      {
        "step": "04",
        "title": "Cartographie & banc",
        "desc": "Mise au point de la cartographie, validation sur banc et route."
      }
    ],
    "faq": [
      {
        "q": "Quelles modifications mécaniques sont nécessaires pour un Stage 2 ?",
        "a": "Selon le véhicule : admission sport, downpipe/décata, intercooler amélioré, durites renforcées. On établit la liste précise lors du devis."
      },
      {
        "q": "Peut-on passer du Stage 1 au Stage 2 ?",
        "a": "Oui, c'est même la progression recommandée. Un tarif préférentiel est appliqué si vous avez déjà un Stage 1 AREPROG."
      },
      {
        "q": "Le Stage 2 est-il utilisable au quotidien ?",
        "a": "Oui, à condition que les modifications mécaniques soient adaptées à un usage route. On propose des cartographies optimisées pour la route ou pour la piste selon votre usage."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "💶",
        "label": "Économies jusqu'à 50%",
        "desc": "L'E85 coûte environ moitié moins que le SP95/98"
      },
      {
        "icon": "🌱",
        "label": "Carburant écologique",
        "desc": "Bioéthanol produit à partir de cultures locales"
      },
      {
        "icon": "⚡",
        "label": "Performances préservées",
        "desc": "ION 102 RON — meilleure résistance à la détonation"
      },
      {
        "icon": "🔄",
        "label": "Flex-fuel possible",
        "desc": "Possibilité de rouler en mixte E85/SP selon les stations"
      }
    ],
    "features": [
    ...
    "process": [
      {
        "step": "01",
        "title": "Vérification compatibilité",
        "desc": "Contrôle injecteurs, pompe à carburant et circuit — certains véhicules nécessitent une mise à niveau."
      },
      {
        "step": "02",
        "title": "Cartographie E85",
        "desc": "Réécriture complète des tables d'injection, allumage et gestion carburant."
      },
      {
        "step": "03",
        "title": "Calibration",
        "desc": "Ajustements fins selon l'état du moteur et les températures de fonctionnement."
      },
      {
        "step": "04",
        "title": "Validation",
        "desc": "Test au bioéthanol sur route, contrôle des richesses et températures."
      }
    ],
    "faq": [
      {
        "q": "Mon véhicule est-il compatible E85 ?",
        "a": "La plupart des moteurs essence turbo produits après 2000 sont compatibles avec un kit ou une simple reprogrammation. On vérifie gratuitement avant toute intervention."
      },
      {
        "q": "Puis-je continuer à mettre du SP95/98 ?",
        "a": "Oui, selon la version : conversion pure E85 ou flex-fuel (compatible les deux). La version flex-fuel est recommandée pour les zones où l'E85 est moins disponible."
      },
      {
        "q": "Quel retour sur investissement ?",
        "a": "Avec une consommation de 8L/100 et 15 000 km/an, le ROI est souvent inférieur à 12 mois selon les prix à la pompe."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "📉",
        "label": "-8 à -15% de consommation",
        "desc": "Gain moyen constaté sur trajets mixtes"
      },
      {
        "icon": "🛣️",
        "label": "Idéal grande route",
        "desc": "Couple bas régime optimisé pour l'autoroute"
      },
      {
        "icon": "💶",
        "label": "ROI rapide",
        "desc": "Amortissement en quelques milliers de km"
      },
      {
        "icon": "🔄",
        "label": "Cumulable",
        "desc": "Compatible avec conversion E85 ou Stage 1"
      }
    ],
    "features": [
    ...
    "process": [
      {
        ...
        "desc": "Évaluation de votre usage (trajet type, km/an) pour orienter la cartographie."
      },
      {
        "step": "02",
        "title": "Lecture ECU",
        "desc": "Extraction de la cartographie d'origine."
      },
      {
        "step": "03",
        "title": "Optimisation",
        "desc": "Réécriture des tables injection et allumage orientées rendement."
      },
      {
        "step": "04",
        "title": "Validation route",
        "desc": "Test sur votre trajet habituel avec mesure de consommation réelle."
      }
    ],
    "faq": [
      {
        "q": "Peut-on combiner optimisation conso et Stage 1 ?",
        "a": "Oui — on peut trouver un équilibre entre performance et économie. Certains clients optent pour une cartographie intermédiaire dite 'éco-sport'."
      },
      {
        "q": "Les gains sont-ils garantis ?",
        "a": "-8 à -15% est une moyenne. Les résultats réels dépendent du style de conduite et des trajets. Garantie de résultat mesurable."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🧹",
        "label": "Admission propre",
        "desc": "Plus de dépôts de suie dans le collecteur d'admission"
      },
      {
        "icon": "⏳",
        "label": "Longévité moteur",
        "desc": "Turbo et injecteurs protégés de l'encrassement"
      },
      {
        "icon": "💻",
        "label": "100% logiciel",
        "desc": "Aucune modification physique — réversible"
      },
      {
        "icon": "🚗",
        "label": "Diesel & essence",
        "desc": "Compatible la majorité des motorisations turbo"
      }
    ],
    "features": [
    ...
    "process": [
      {
        "step": "01",
        "title": "Diagnostic",
        "desc": "Lecture de l'état de la vanne EGR, vérification de l'absence de panne mécanique active."
      },
      {
        "step": "02",
        "title": "Lecture ECU",
      ...
      },
      {
        "step": "03",
        "title": "Désactivation",
        "desc": "Suppression logicielle de la boucle EGR dans le calculateur."
      },
      {
        "step": "04",
        "title": "Validation",
        "desc": "Effacement des codes défauts et vérification de l'absence de voyants."
      }
    ],
    "faq": [
      {
        "q": "La désactivation EGR est-elle détectable au contrôle technique ?",
        "a": "Non — le contrôle technique français mesure les émissions à l'échappement, pas la présence de la vanne EGR. La désactivation logicielle n'impacte pas les valeurs mesurées."
      },
      {
        "q": "Faut-il aussi désactiver physiquement la vanne ?",
        "a": "Non, la désactivation logicielle suffit et est préférable. La vanne reste en place mais est ignorée par le calculateur."
      },
      {
        "q": "Peut-on combiner EGR + FAP OFF ?",
        "a": "Oui, et c'est fréquent. On propose un tarif pack pour les deux opérations lors de la même intervention."
      }
    ],
    "relatedIds": [
      "fap",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🚫",
        "label": "Fin des régénérations",
        "desc": "Plus de phases de nettoyage forcées et de surconsommation associée"
      },
      {
        "icon": "🔧",
        "label": "Pas de panne FAP",
        "desc": "Suppression de la source première de pannes diesel"
      },
      {
        "icon": "💡",
        "label": "Voyant supprimé",
        "desc": "Plus de témoin FAP allumé"
      },
      {
        "icon": "🩺",
        "label": "Diagnostic inclus",
        "desc": "Vérification de l'état général avant intervention"
      }
    ],
    "features": [
    ...
    "process": [
      {
        "step": "01",
        "title": "Diagnostic FAP",
        "desc": "Lecture du taux de colmatage, contrôle des capteurs de pression différentielle."
      },
      {
        "step": "02",
        "title": "Lecture ECU",
      ...
      },
      {
        "step": "03",
        "title": "Suppression",
        "desc": "Désactivation de la gestion FAP, cartographie injection adaptée."
      },
      {
        "step": "04",
        "title": "Validation",
        "desc": "Effacement des codes défauts, vérification tableau de bord."
      }
    ],
    "faq": [
      {
        "q": "La suppression FAP est-elle détectable au contrôle technique ?",
        "a": "Le contrôle technique mesure l'opacité des fumées. Un FAP supprimé sur un moteur bien entretenu passe généralement sans problème. Nous conseillons de vérifier avant contrôle."
      },
      {
        "q": "Faut-il retirer physiquement le FAP ?",
        "a": "Non obligatoire pour la partie logicielle. Certains clients retirent ensuite physiquement le filtre — nous pouvons vous conseiller sur les options."
      },
      {
        "q": "Quelle différence entre FAP et AdBlue ?",
        "a": "Le FAP filtre les particules solides. L'AdBlue (SCR) traite les oxydes d'azote (NOx) via injection d'urée. Ce sont deux systèmes distincts — on peut désactiver l'un ou les deux."
      }
    ],
    "relatedIds": [
      "egr",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🚨",
        "label": "Fin des alertes AdBlue",
        "desc": "Plus de messages d'alerte niveau ou qualité"
      },
      {
        "icon": "🔒",
        "label": "Plus de risque de blocage",
        "desc": "Le blocage moteur progressif lié à l'AdBlue est supprimé"
      },
      {
        "icon": "💶",
        "label": "Économies entretien",
        "desc": "Plus de remplissage ni de réparation système SCR"
      },
      {
        "icon": "💻",
        "label": "100% logiciel",
    ...
    "process": [
      {
        "step": "01",
        "title": "Diagnostic SCR",
        "desc": "Lecture des défauts liés au système AdBlue, évaluation de l'état du module."
      },
      {
        "step": "02",
        "title": "Lecture ECU",
        "desc": "Extraction de la cartographie."
      },
      {
        "step": "03",
        "title": "Suppression SCR",
        "desc": "Désactivation complète du système SCR/AdBlue dans l'ECU."
      },
      {
        "step": "04",
        "title": "Validation",
        "desc": "Effacement codes défauts, confirmation de l'absence de messages d'alerte."
      }
    ],
    "faq": [
      {
        "q": "Mon moteur risque-t-il d'être bridé après la suppression AdBlue ?",
        "a": "Non — après la désactivation, la limitation progressive liée au système AdBlue est supprimée. Le moteur fonctionne à pleine puissance en permanence."
      },
      {
        "q": "Est-ce compatible avec la désactivation FAP ou EGR ?",
        "a": "Oui, les trois systèmes sont indépendants. On peut tout traiter lors de la même intervention avec un tarif pack."
      }
    ],
    "relatedIds": [
      "egr",
  ...
  },
  {
    ...
    "benefits": [
      ...
      {
        "icon": "🧹",
        "label": "EGR OFF inclus",
        "desc": "Admission propre, longévité moteur préservée"
      },
      {
        "icon": "💶",
        "label": "50€ économisés",
        "desc": "Par rapport aux deux prestations séparées"
      },
      {
        "icon": "🚗",
        "label": "1 seule venue",
        "desc": "Technicien à domicile, tout en une fois"
      }
    ],
    "features": [
    ...
    "faq": [
      {
        "q": "Les deux prestations sont-elles réalisées lors de la même venue ?",
        "a": "Oui, c'est l'intérêt du pack. Un seul déplacement, deux fichiers écrits lors de la même session."
      },
      {
        "q": "Peut-on ajouter la désactivation FAP au pack ?",
        "a": "Oui, nous proposons aussi le pack Triple (Stage 1 + EGR + FAP) avec 100€ d'économie."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      ...
      {
        "icon": "🚫",
        "label": "FAP OFF inclus",
        "desc": "Fin des régénérations et pannes FAP"
      },
      {
        "icon": "💶",
        "label": "60€ économisés",
      ...
      {
        "icon": "🚗",
        "label": "Diesel uniquement",
        "desc": "Optimisé pour moteurs diesel turbo"
      }
    ],
    "features": [
    ...
    "faq": [
      {
        "q": "Ce pack est-il réservé aux diesels ?",
        "a": "Oui, la suppression FAP ne concerne que les moteurs diesel. Pour l'essence, on recommande le pack Stage 1 + EGR."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      ...
      },
      {
        "icon": "🧹",
        "label": "EGR OFF inclus",
        "desc": "Admission propre, moteur protégé"
      },
      {
        "icon": "🚫",
        "label": "FAP OFF inclus",
        "desc": "Fin définitive des régénérations forcées"
      },
      {
        "icon": "💶",
        "label": "100€ économisés",
        "desc": "Meilleur rapport qualité/prix du catalogue"
      }
    ],
    "features": [
    ...
    "faq": [
      {
        "q": "Peut-on ajouter AdBlue OFF à ce pack ?",
        "a": "Oui, moyennant un supplément. Contactez-nous pour un devis personnalisé incluant AdBlue."
      },
      {
        "q": "Ce pack est-il disponible pour l'essence ?",
        "a": "Partiellement — Stage 1 + EGR est disponible en essence. Le FAP OFF concerne uniquement le diesel."
      }
    ],
    "relatedIds": [
      "stage1",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🔌",
        "label": "Universel OBD2",
        "desc": "Compatible tous protocoles : CAN, ISO, KWP, J1850"
      },
      {
        "icon": "📱",
        "label": "Multi-plateforme",
        "desc": "PC, Android, iOS — compatible tous logiciels OBD"
      },
      {
        "icon": "📦",
        "label": "Expédié sous 48h",
        "desc": "Livraison colissimo incluse dans le prix"
      },
      {
        "icon": "🛡️",
        "label": "Câble renforcé",
        "desc": "1,8m, connecteurs en métal brossé"
      }
    ],
    "features": [
    ...
    "faq": [
      {
        "q": "Avec quels logiciels est-il compatible ?",
        "a": "VCDS Lite, EOBD Facile, Forscan, Torque (Android), OBD Fusion (iOS) et la majorité des applications OBD du marché."
      },
      {
        "q": "Est-il compatible avec les véhicules récents ?",
        "a": "Oui, tous les véhicules produits après 2004 (Europe) et 1996 (USA) sont équipés du port OBD2 standard."
      }
    ],
    "relatedIds": [
      "vag-com",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🎯",
        "label": "Groupe VAG complet",
        "desc": "VW, Audi, Seat, Skoda, Porsche — tous modules"
      },
      {
        "icon": "💻",
        "label": "Logiciel inclus",
        "desc": "VCDS compatible inclus dans le pack"
      },
      {
        "icon": "🔄",
        "label": "Mises à jour gratuites",
        "desc": "Accès aux mises à jour logiciel sans surcoût"
      },
      {
        "icon": "📦",
        "label": "Expédié sous 48h",
        "desc": "Avec câble USB, documentation et accès logiciel"
      }
    ],
    "features": [
    ...
    "faq": [
      {
        "q": "Fonctionne-t-il sur les véhicules récents ?",
        "a": "Oui, compatible jusqu'aux véhicules 2025 avec les dernières mises à jour logiciel."
      },
      {
        "q": "Peut-on coder des options avec cet outil ?",
        "a": "Oui — activation de fonctions cachées (DRL, affichage huile, etc.) selon le véhicule."
      }
    ],
    "relatedIds": [
      "cable-obd2",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🎁",
        "label": "Cadeau original",
        "desc": "Pour les passionnés qui ont déjà tout"
      },
      {
        "icon": "📧",
        "label": "Envoi par email",
        "desc": "Bon reçu immédiatement après paiement"
      },
      {
        "icon": "📅",
        "label": "Valable 1 an",
        "desc": "Le temps de planifier l'intervention"
      },
      {
        "icon": "🔄",
        "label": "Sur tout le catalogue",
        "desc": "Utilisable sur toutes les prestations"
      }
    ],
    "features": [
      "Valable sur toutes les prestations",
      "Envoi par email sous 24h",
      "Valable 1 an"
    ],
    "faq": [
      {
        "q": "Comment le bénéficiaire utilise-t-il le bon ?",
        "a": "Il contacte AREPROG avec le code reçu par email. Le montant est déduit du devis de sa prestation."
      },
      {
        "q": "Le bon est-il cumulable ?",
        "a": "Oui, plusieurs bons peuvent être cumulés sur une même prestation."
      }
    ],
    "relatedIds": [
      "gift-200",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🎁",
        "label": "Couvre un Stage 1",
        "desc": "Sur la majorité des véhicules diesel/essence"
      },
      {
        "icon": "📧",
        "label": "Envoi par email",
      ...
      },
      {
        ...
        "desc": "Notre bon cadeau le plus populaire"
      }
    ],
    "features": [
      "Couvre la majorité des Stage 1",
      "Envoi par email sous 24h",
      "Valable 1 an"
    ],
    "faq": [
      {
        "q": "200€ couvrent-ils toujours un Stage 1 complet ?",
        "a": "Sur la majorité des véhicules, oui. Pour les motorisations spécifiques (exotiques, très grosses cylindrées), un complément peut être demandé."
      }
    ],
    "relatedIds": [
      "gift-100",
  ...
  },
  {
    ...
    "benefits": [
      {
        "icon": "🎁",
        "label": "Stage 1 + options",
        "desc": "Couvre un Stage 1 complet avec options"
      },
      {
        "icon": "📧",
        "label": "Envoi par email",
      ...
      },
      {
        "icon": "📅",
        "label": "Valable 1 an",
        "desc": "Pour prendre le temps de bien planifier"
      },
      {
        "icon": "🔄",
        "label": "Flexible",
        "desc": "Utilisable sur n'importe quelle prestation"
      }
    ],
    "features": [
      "Stage 1 complet avec options",
      "Envoi par email sous 24h",
      "Valable 1 an"
    ],
    "faq": [
      {
        "q": "Ce bon peut-il couvrir un pack ?",
        "a": "Oui, il peut contribuer à un pack — la différence est réglée directement avec le technicien."
      }
    ],
    "relatedIds": [
      "gift-100",
